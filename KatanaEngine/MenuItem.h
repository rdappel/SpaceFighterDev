...
namespace KatanaEngine
{
	...
	public:
		...
		/** @brief Instantiate a menu item.
			@param text The text that the item will display. The default is an empty string.
		...
		/** @brief Gets the text offset of the menu item.
			@return Returns the menu item's text offset. */
		virtual Vector2 GetTextOffset() const { return m_textOffset; }
