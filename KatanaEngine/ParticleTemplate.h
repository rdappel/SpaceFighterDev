...
namespace KatanaEngine
{
	...
	class ParticleTemplate
	{
		...
		friend void Particle::Update(const GameTime& gameTime);
		friend void Particle::Draw(SpriteBatch& spriteBatch);
		friend void Emitter::Update(const GameTime& gameTime);
	...
	protected:
		...
		virtual void UpdateParticle(Particle *pParticle, const GameTime& gameTime) { }
