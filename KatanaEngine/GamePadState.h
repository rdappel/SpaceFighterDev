...
namespace KatanaEngine
{
	...
	struct GamePadDPad
	{
		ButtonState Up = ButtonState::RELEASED;		/**< The state of the Up Button on the directional pad. */
		ButtonState Down = ButtonState::RELEASED;	/**< The state of the Down Button on the directional pad. */
		ButtonState Left = ButtonState::RELEASED;	/**< The state of the Left Button on the directional pad. */
		ButtonState Right = ButtonState::RELEASED;	/**< The state of the Right Button on the directional pad. */
	};
	...
	{
		float Left = 0;				/**< The value of the Left Trigger. */
		float Right = 0;			/**< The value of the Left Trigger. */
	};
	...
	{
		Vector2 Left = Vector2::ZERO;	/**< The position of the Left Thumbstick. */
		Vector2 Right = Vector2::ZERO;	/**< The position of the Right Thumbstick. */
	};
	...
	{
		ButtonState A = ButtonState::RELEASED;				/**< The state of the A Button. */
		ButtonState B = ButtonState::RELEASED;				/**< The state of the B Button. */
		ButtonState X = ButtonState::RELEASED;				/**< The state of the X Button. */
		ButtonState Y = ButtonState::RELEASED;				/**< The state of the Y Button. */

		ButtonState Start = ButtonState::RELEASED;			/**< The state of the Start Button. */
		ButtonState Back = ButtonState::RELEASED;			/**< The state of the Back Button. */

		ButtonState LeftStick = ButtonState::RELEASED;		/**< The state of the Left Stick Button. */
		ButtonState LeftShoulder = ButtonState::RELEASED;	/**< The state of the Left Shoulder Button. */
		ButtonState RightStick = ButtonState::RELEASED;		/**< The state of the Right Stick Button. */
		ButtonState RightShoulder = ButtonState::RELEASED;	/**< The state of the Right Shoulder Button. */
	};
	...
	struct GamePadState
	{
		bool IsConnected = true;				/**< @brief True if the GamePad is connected, false otherwise. */
		GamePadButtons Buttons = GamePadButtons{};			/**< @brief The current state of the GamePad's Buttons. */
		GamePadThumbSticks Thumbsticks = GamePadThumbSticks{};	/**< @brief The current state of the GamePad's Thumbsticks. */
		GamePadTriggers Triggers = GamePadTriggers{};		/**< @brief The current state of the GamePad's Triggers. */
		GamePadDPad DPad = GamePadDPad{};				/**< @brief The current state of the GamePad's DPad. */
